...
retrieval_questions: ["Claude Code 개요란 무엇인가?", "Claude Code 개요의 핵심 개념은?", "Claude Code 개요의 설치 (2026년 네이티브 설치 권장)은 무엇인가?", "Claude Code 개요의 최소 구성 시작점은 무엇인가?", "Claude Code 개요의 일상 워크플로우는 무엇인가?"]
